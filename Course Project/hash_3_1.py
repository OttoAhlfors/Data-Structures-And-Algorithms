...
if __name__ == "__main__":
    ...
    table = HashTable(11000)

    print("Initializing the hash table took", timeit.default_timer() - starttime)
    starttime = timeit.default_timer()
    ...
    print("The inserts took", timeit.default_timer() - starttime)
